...
import com.glpsns.config.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
		    ...
		    .mvcMatchers("/", "/members/**").permitAll() //모든 사용자가 로그인(인증) 없이 접근할 수 있도록 설정
		    .mvcMatchers("/profile/**", "/story/**").hasRole("USER")
